    ...
    return ( 
         ...
         <div class= "flex h-screen xl:flex-col md:flex-col md:h-auto xl:h-auto">
           ...
           <div className="w-1/2 flex bg-zinc-400 h-screen items-center justify-center p-48 2xl:w-full md:flex md:items-center md:justify-center md:p-12" id="parthree">
               ...
               <div className="w-1/2 object-cover flex h-screen items-center justify-center pl-64 text-2xl text-white p-80 2xl:w-full 2xl:object-cover md:flex md:items-center md:justify-center md:text-base md:p-10 "> 
          ...
          <div class="flex w-full h-48 bg-black text-white items-center justify-center flex-col absolute mt-[761px] 2xl:w-full 2xl:mt-[1600px] sm:flex sm:items-center sm:justify-center">
                 ...
                 <div className="pt-2 text-2xl md:text-xl">Get in touch at &#8595;</div>
                          <div class="font-medium text-4xl text-purple-500 hover:text-slate-300 hover:ease-out duration-150 mt-1 md:text-2xl" onClick={() => {
                               window.location.href="mail" 
                                    ...
                                    <div className="text-white text-sm mt-4 gap-2 md:flex md:text-xs md:items-center md:justify-center">Tips About Me: My nickname is "Ventunos" this is fully version and shorter one is "ven". That is why I use this one for my github account.</div>
                ...
                <div className='text-white absolute bottom-0 right-0 h-16 w-16 animate-bounce md:h-12' onClick={() => {
